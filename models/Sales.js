...
var Sales = {
    ...
    getAllSalesByVendorWithDetails: function() {
        return db.query("select nickname, user_name, products_product_code, products_product_version, product_name, quantity, price from sales s join users u on s.customer_cpf = u.cpf join products p on p.id_product = s.products_id_product where u.cpf = ?", [vendor_cpf], callback);
    },
